...
$title = "Siswa - SMA NEGERI 1 SURAKARTA";
                            ...
                            <table class="table table-hover" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="hapus-siswa.php?nis=<?= $data['nis'] ?>&foto=<?= $data['foto'] ?>" class="btn btn-sm btn-danger" title="Hapus Siswa" onclick="return confirm('Apakah anda yakin akan menghapus data ini ?')"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
