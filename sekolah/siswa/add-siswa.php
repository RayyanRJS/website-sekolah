...
$title = "Tambah Siswa - SMA Negeri 1 Surakarta";
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" name="nis" required readonly class="form-control-plaintext border-bottom ps-2" id="nis" value="<?= $maxnis ?>">
                                </div>
                            </div>
                                    <div class="mb-3 row">
                                ...
                                <select name="kelas" id="kelas" class="form-select border-0 border-bottom" required>
                                    <option selected>--Pilih kelas-- (untuk kelas 11 dan 12 silakan scroll kebawah)</option>
