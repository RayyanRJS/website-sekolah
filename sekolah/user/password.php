...
$title = "Ganti Password SMA Negeri 1 Surakarta";
                        ...
                        <div class="card">
                            ...
                            <div class="mb-3 row">
                                <div class="col-7">
                                    ...
                                    <input type="password" class="form-control" id="newPass" name="newPass" minlength="8" maxlength="20" placeholder="Masukan password baru anda" required>
                                </div>
                                </div>
                                <div class="mb-3 row">
                                <div class="col-7">
