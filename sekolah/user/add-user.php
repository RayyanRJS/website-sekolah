...
$title = "Tambah User - SMA NEGERI 1 SURAKARTA";
...
if ($msg == 'oversize') {
  $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-xmark"></i> Tambah user gagal, maksimal ukuran gambar 2 mb 
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if ($msg == 'added') {
  $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-circle-check"></i> Tambah user user berhasil, segera ganti password anda ! 
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
?>
...
<div id="layoutSidenav_content">
  ...
  <div class="card-body">
    ...
    <div class="col-sm-9" style="margin-left: -50px;">
      <input type="text" pattern="[A-Za-z0-9]{3,}" title="minimal 3 karakter kombinasi huruf besar, huruf kecil, dan angka" class="form-control" id="username" name="username" maxlenght="20" required>
    </div>
  </div>
  <div class="mb-3 row">
    ...
    <label for="" class="col-sm-1 col-form-label">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
      <input type="text" class="form-control" id="nama" name="nama" maxlenght="20" required>
    </div>
  </div>
  <div class="mb-3 row">
