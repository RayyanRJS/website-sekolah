...
$title = "Profile Sekolah SMA NEGERI 1 SURAKARTA";
...
if (isset($_GET['msg'])) {
  ...
  if ($msg == 'oversize') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-triangle-exclamation"></i> Update data sekolah gagal, maksimal ukuran gambar 2 mb 
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
  }
  if ($msg == 'updated') {
...
<div id="layoutSidenav_content">
  ...
  <div class="card-body">
    <div class="row">
        <div class="col-4 text-center px-5" >
            ...
            <small class="text-secondary">Pilih gambar PNG, JPG, atau JPEG dengan ukuran maksimal 2 MB</small>
        </div>
        <div class="col-8">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-9" style="margin-left: -50px;">
      <select name="akreditasi" id="akreditas" class="form-select border-0 border-bottom" required>
  ...
  <div class="mb-3 row">
    <label for="visimis" class="col-sm-2 col-form-label">Visi dan Misi</label>
